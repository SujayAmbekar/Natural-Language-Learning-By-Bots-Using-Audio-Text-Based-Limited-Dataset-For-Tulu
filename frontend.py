...
def translatenow_button():
    ...
    tk.Button(translatenow_window, text="Generate Sentences",fg = "black",bg='white',font = "Verdana 26 bold").pack(side=TOP, anchor='ne', padx=25, pady=5)
    ...
    tk.Button(translatenow_window, text="Translate",fg = "black",bg='white',font = "Verdana 26 bold", command=translate_button).pack(side=LEFT, anchor='n', padx=25, pady=5)
    translatenow_window.mainloop()

tk.Button(window, text="Start",fg = "blue",bg='white',font = "Verdana 26 bold", command=translatenow_button).pack(pady= 70)
